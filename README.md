...
*  **STT_3_Spont_Whisper_V2.1**. Whisper: Spontaneous Speech Version 2.1: Whisper fine-tuned on the spontaneous speech data set. save-steps = 400, other settings of the comparable Whisper version *(Thesis: Comparable Whisper spontaneous speech)
* **STT_3_Spont_Whisper_V2.2**. Whisper: Spontaneous Speech Version 2.2: Whisper fine-tuned on the spontaneous speech data set. save-steps = 100 & other default settings of the Whisper model *(Thesis: Default Whisper spontaneous speech)
