...
audio_data = load_dataset("audiofolder", data_dir="/Users/karinthommen/Library/CloudStorage/OneDrive-Persönlich/_UZH/Master/Master_Thesis/Data/SDS-200")

print(audio_data)
print(audio_data["train"][0])

audio_data.push_to_hub("karinthommen/sds200", private=True)